...
import static model.enums.ItemCategory.FOOD_GROCERIES;
		...
		Item newItem = null;
			switch (category){
				case ELECTRONICS -> {
					...
					ElectronicsItem item =  new ElectronicsItem(name, manufacturer, country, description, id, quantity, electronicsType,
